...
CREATE TABLE "activities" (
    ...
    CONSTRAINT "activities_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "categories" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_tickets" ("ai_summary", "created_at", "department", "description", "id", "priority", "status", "title", "updated_at", "user_id") SELECT "ai_summary", "created_at", "department", "description", "id", "priority", "status", "title", "updated_at", "user_id" FROM "tickets";
DROP TABLE "tickets";
...
-- CreateIndex
CREATE UNIQUE INDEX "activities_name_category_id_key" ON "activities"("name", "category_id");
